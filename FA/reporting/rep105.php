...
function GetSalesOrders($from, $to, $category=0, $location=null, $backorder=0, $salestype=null)
{
 ...
 */
        $sql= "SELECT ".TB_PREF."sales_orders.order_no,
            ...
            FROM ".TB_PREF."sales_orders
                ...
                INNER JOIN ".TB_PREF."sales_types 
                    ON ".TB_PREF."sales_orders.order_type = ".TB_PREF."sales_types.id
            WHERE ".TB_PREF."sales_orders.ord_date >='$fromdate'
                AND ".TB_PREF."sales_orders.ord_date <='$todate'";
	...
	if ($backorder)
        ...
        if ($salestype > 0)
                $sql .= " AND ".TB_PREF."sales_orders.order_type=$salestype";
        
        $sql .= " GROUP BY ".TB_PREF."cust_branch.salesman, ".TB_PREF."stock_master.category_id, ".TB_PREF."sales_order_details.stk_code";
	$sql .= " ORDER BY ".TB_PREF."cust_branch.salesman, ".TB_PREF."stock_master.category_id, ".TB_PREF."sales_order_details.stk_code";
...
function print_order_status_list()
{
	...
	$result = GetSalesOrders($from, $to, $category, $location, $backorder, $salestype);
	...
	while ($myrow=db_fetch($result))
	{
                ...
                if ($orderno != $myrow['salesman'])
		{
			...
			//$rep->TextCol(2, 3,	get_branch_name($myrow['branch_code']));
                        ...
                        $rep->TextCol(1, 2,	$myrow['salesman_name']." (".$myrow['sales_type'].")");
