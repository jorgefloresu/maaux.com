...
function GetSalesmanTrans($from, $to)
{
	...
	$sql = "SELECT DISTINCT ".TB_PREF."debtor_trans.*,
        ...
        if ($_SESSION["wa_current_user"]->access == 11)
            $sql .= " AND ".TB_PREF."salesman.salesman_name LIKE '".substr($_SESSION["wa_current_user"]->username,0,2)."-%'";
        
	$sql .=	" ORDER BY ".TB_PREF."salesman.salesman_code, ".TB_PREF."debtor_trans.tran_date";
